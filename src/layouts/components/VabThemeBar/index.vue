<template>
	<span v-if="themeBar">
		...
		<div class="theme-bar-setting">
			...
			<div @click="handleUploader">
				<vab-icon :icon="['fas', 'upload']"></vab-icon>
				<p>上传器</p>
			</div>
		</div>

		<el-drawer title="主题配置" :visible.sync="drawerVisible" direction="rtl" append-to-body size="470px">
		...
		<uploader-dialog ref="uploader-dialog"></uploader-dialog>
...
export default {
	...
	methods: {
		...
		handleUploader(){
			this.$refs['uploader-dialog'].show();
		}
	},
}
</script>
